...
var translations = {
	...
	sk_SK: {
		...
		Filter: 'Filter',
		Reset: 'Reset',
		'No barbarian villages found!': 'Neboli nájdené žiadne dediny barbarov!',
	...
	hr_HR: {
		...
		'Error while fetching "village.txt"!': 'Greška u dohvaćanju podataka "village.txt"!',
		Coords: 'Koordinati',
		Points: 'Poeni',
		'Dist.': 'Distanca.',
		Attack: 'Napad',
	...
	pl_PL: {
		...
		'Error while fetching "village.txt"!': 'Błąd podczas wyszukiwania pliku„ village.txt ”!',
		Coords: 'Koordy',
		Points: 'Punkty',
		'Dist.': 'Odległość',
		Attack: 'Atak',
		Filter: 'Znajdź',
		Reset: 'Reset',
		'No barbarian villages found!': 'Nie znaleziono wiosek barbarzyńskich',
