            ...
            $.ajax({
                    ...
                    success: function() {
                            ...
                            var hms = $("#incomings_table").find("tr").eq(timesRun).find("td").eq(6).text().split(':'),
                                    ...
                                    commandName = $("#incomings_table").find("tr").eq(timesRun).find("td").eq(0).text().trim();
                            ...
                            } else if (commandName.includes("Aríete") || commandName.includes("Cata") || commandName.includes("Catapulta")) {
